...
from sispag.models import Pessoa, Endereco
...
def boleto_bb(request):           
    ...
    dados['sacado'] = pessoa.nome
    if endereco :
        dados['endereco1'] = endereco.logradouro
        dados['endereco2'] = endereco.cidade +  '-' + endereco.estado + '- CEP:' + endereco.cep
    else:
        dados['endereco1'] = u'Bairro não cadastrado'
        dados['endereco2'] = u'Endereço não cadastrado' 

    # Informações para o cliente 
    dados['demonstrativo1'] = 'Pagamento de Mensalidade'
    dados['demonstrativo2'] = u"""Mensalidade referente ao mês de """ + mes(request.GET.get('mes'))
    dados['demonstrativo3'] = 'Colegio Teste'
    ...
    dados['instrucoes4'] = '- Emitido pelo sistema sispag do colegio Teste '
    ...
    # Deus Dados     
    dados['identificacao'] = ' Colegio Teste '
    dados['cpf_cnpj'] = '11.111.111/1111-11'
    dados['endereco'] = 'Av. Teste , Teste de Caxias'
    dados['cidade_uf'] = 'Maceió / AL'
    dados['cedente'] = 'Colegio Teste LTDA'
